        ...
        charts: [
          {
            ...
            json: {
              ...
              title: {
                useHTML: true,
                text: '<span class="chart-title">Annual Promotional Cost</span><span class="fa fa-question-circle" data-toggle="tooltip" title="Compare the costing for various promotions"></span>'
              },
              tooltip: {
