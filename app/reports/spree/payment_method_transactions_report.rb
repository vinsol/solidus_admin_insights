        ...
        charts: [
          {
            ...
            json: {
              ...
              title: {
                useHTML: true,
                text: "<span class='chart-title'>Payment Methods</span><i class='glyphicon glyphicon-question-sign' data-toggle='tooltip' title=' Compare the revenue generated by different Payment methods such as CC, Check etc.'></i>"
              },
