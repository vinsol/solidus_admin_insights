        ...
        charts: [
          {
            ...
            json: {
              ...
              title: {
                useHTML: true,
                text: "<span class='chart-title'>Monthly Sales Tax Comparison</span><i class='glyphicon glyphicon-question-sign' data-toggle='tooltip' title='Compare the Sales tax collected from different Zones'></i>"
              },
